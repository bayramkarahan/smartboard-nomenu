...
void Scene::donSlot(DiagramItem::DiagramType type)
        ...
        Scene::Mode mode;
                  ...
                  DiagramItem::DiagramType::IzometrikKagit==mySekilType)
          {
             ...
             QPixmap pg;
               if(DiagramItem::DiagramType::NoktaliKagit==mySekilType)
               {
                  pg=QPixmap(":/icons/noktalikagit.png");
                //  qDebug()<<"donSlot noktalikagit1";
                 // setImage(QPixmap(":/icons/noktalikagit.png"));
               }


              if(DiagramItem::DiagramType::IzometrikKagit==mySekilType)
                  pg=QPixmap(":/icons/izometrikkagit.png");

              if(DiagramItem::DiagramType::KareliKagit==mySekilType)
              pg=QPixmap(":/icons/karelikagit.png");
    ...
    if(DiagramItem::DiagramType::Gonye==mySekilType)setImage(QPixmap(":/icons/gonye.png"));
     if(DiagramItem::DiagramType::NDogru==mySekilType)setImage(QPixmap(":/icons/ndogru.png"));
    if(DiagramItem::DiagramType::NKoordinat==mySekilType)setImage(QPixmap(":/icons/nkoordinat.png"));
    if(DiagramItem::DiagramType::NNKoordinat==mySekilType)setImage(QPixmap(":/icons/nnkoordinat.png"));
    if(DiagramItem::DiagramType::HNKoordinat==mySekilType)setImage(QPixmap(":/icons/hnkoordinat.png"));
/*
    if(DiagramItem::DiagramType::NoktaliKagit==mySekilType)setImage(QPixmap(":/icons/noktalikagit.png"));
    if(DiagramItem::DiagramType::IzometrikKagit==mySekilType)setImage(QPixmap(":/icons/izometrikkagit.png"));
    if(DiagramItem::DiagramType::KareliKagit==mySekilType)setImage(QPixmap(":/icons/karelikagit.png"));
    if(DiagramItem::DiagramType::CizgiliKagit==mySekilType)setImage(QPixmap(":/icons/cizgilikagit.png"));
    /**/
    if(!itemToRectDraw){
        //  qDebug()<<"3";
...
itemToRectDraw->setRect(0,0,width()/4,height()/3);
}
...
itemToRectDraw->setRect(0,0,width()/10,height()/5);
}
   ...
   itemToRectDraw->setRect(0,0,width()/2,height()/20);
}
   ...
   // itemToRectDraw->setPos(qFabs(screenSize.width()/2)-300,qFabs(screenSize.height()/2)-350);
      itemToRectDraw->setRect(0,0,width()/2,height()/2);
}
...
void Scene::mouseMoveEvent(QGraphicsSceneMouseEvent *event){
   ...
   // qDebug()<<"mouseMove myMousePress:"<<myMousePress<<sceneModeTrue<<Scene::ModeTrue::DrawPenTrue;
     if(myMousePress){
...
if(tv->centerPoint==false)
{
 ...
 ,tv->scenePos().x()+tv->boundingRect().width()+1,tv->scenePos().y()+tv->boundingRect().height()+1
      ...
      tv->centerPoint=true;
         ...
         // itemToPenDraw->setTransform(Qt::SmoothTransformation);
          origPoint = event->scenePos();
           endPos=event->scenePos();
